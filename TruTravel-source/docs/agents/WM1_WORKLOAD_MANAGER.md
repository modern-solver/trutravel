...
**Master assignment board:** [`WORK_PLAN_M0_TO_PRODUCT_TEST.md`](./WORK_PLAN_M0_TO_PRODUCT_TEST.md) — tickets for all agents from kickoff through product testing (TEST-GATE).
